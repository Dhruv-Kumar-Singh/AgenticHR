                  ...
                  {selectedDeck.scenarios.map((sc) => {
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-2xl p-5 sm:p-6 flex flex-col justify-between transition-all duration-300 cursor-pointer relative overflow-hidden group ${
                          isSelected
                      ...
                      >
                        <div>
                          ...
                          <h4 className={`text-sm sm:text-base font-semibold leading-snug mb-2.5 transition-colors ${
